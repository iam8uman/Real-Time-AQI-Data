...
//       if (!meData?.id) return
//       try {
//         const { sensorDataValue } = await fetchSensorData(meData?.id, [
//           "device.type=eq_STATIONERY",
//         ])
//         setStationeryData(sensorDataValue)
//       } catch (error) {
//         console.error("Error fetching stationery data: of particular user", error)
//       }
//     }
...
//         const keiLabels: { [key: number]: string } = {
//           0: 'PM 2.5',
//           1: 'Humidity',
//           2: 'Temperature',
//         };
//         const popupContent = `
//            <div>
//              <p>Sensor Data: ${keiLabels[kei]} = ${value}</p>
