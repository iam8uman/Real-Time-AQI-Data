...
import HeatMapUser from "@/components/userMap/OSMap"

const OSMap = dynamic(() => import("@/components/userMap/OSMap2"), {
  ssr: false,
})
...
const page = () => {
  ...
  return (
    <div className="text-slate-300 overflow-hidden bg-slate-950">
